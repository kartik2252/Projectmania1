				...
				<div class="row-2">
					<nav>
						...
						<li><a  href="LoginPage.jsp">Home Page</a></li>
						 <li><a class="active" href="UploadedProjects.jsp" >Uploaded Projects</a></li>
						<li><a href="AdminLiveProject.jsp" >Live Projects</a></li>
...
<table width="800" height="43" class="hovertable">
<tr>
	<th width="33">Id</th><th width="215" style="font-size: 18px;">Project Name</th><th width="84">Category</th><th width="79">Date</th><th width="192" >Description</th><th width="100">Download</th><th width="60">Delete</th>
</tr>
 <%   
...
<tr onmouseover="this.style.backgroundColor='#CCC';"  onmouseout="this.style.backgroundColor='#fff';" align="center">
	  <td><%= s1 %></td>
                <td style="font-size: 16px"><%= s3 %></td>
                <td style="font-size: 16px"><%= s4 %></td>
                <td><%= s2 %></td>
                <td align="left"><%= s5 %></td>
                <td><a href="Download.jsp?id=<%=s1 %>" target="_blank" style="text-decoration:none; font-weight:bold; color:#F00; font-size: 18px; ">Download</a></td>
                 <td><a href="Delete.jsp?id=<%=s1 %>" target="_blank" style="text-decoration:none; font-weight:bold; color:#F00; font-size: 18px; ">Delete</a></td>
            </tr>
